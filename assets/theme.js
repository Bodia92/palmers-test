  ...
  */
  ...
  var LoginSection = /*#__PURE__*/function () {
    function LoginSection(element) {
      ...
      this.element = element;
      this.domDelegate = new Delegate(this.element);
      this.customerLoginForm = this.element.querySelector('#customer_api_login');
      this.recoverPasswordForm = this.element.querySelector('#recover_customer_password');
      this.resetPasswordForm = this.element.querySelector('#customer_api_reset');
      this.domDelegate.on('click', '[data-action="toggle-login-form"]', this._showRecoverPassword.bind(this));
      this.customerLoginForm.hidden = true;
      this._showRecoverPassword();
    }
    ...
    _createClass(LoginSection, [{
      ...
      value: function _showRecoverPassword() {
        ...
        var isLoginActive = window.location.hash == '#recover' ? true : this.customerLoginForm.hidden == false;
        var isResetActive = gets.get('token') ? true : false;
        ...
        if(!isResetActive) {
          if (isLoginActive) {
            ...
            this.customerLoginForm.hidden = true;
            this.recoverPasswordForm.hidden = false;
            this.resetPasswordForm.hidden = true;
          } else {
            // this.customerLoginForm.style.display = 'block';
            // this.recoverPasswordForm.style.display = 'none';
            this.customerLoginForm.hidden = false;
            this.recoverPasswordForm.hidden = true;
            this.resetPasswordForm.hidden = true;
          }
        }
        else {
          this.customerLoginForm.hidden = true;
          this.recoverPasswordForm.hidden = true;
          this.resetPasswordForm.hidden = false;
        }
      }
    }]);
